...
def main():
    ...
    def smooth_mesh(vis:o3d.visualization.Visualizer):
        print("Current Params - Loops: {:d}; Lambda - {:.2f};".format(main.loops, main._lambda))
        if main.loops == 0:
            ...
            opc_smooth, pcd_smooth = laplacian_opc(pc_image, loops=main.loops, _lambda=main._lambda, max_dist=0.25)
