# -*- coding: utf-8 -*-
# Pulled from Open3D
# OrganizedPointFilters documentation build configuration file, created by
...
# Import organizedpointfilters raw python package with the highest priority
# This is a trick to show organizedpointfilters.organizedpointfilters as organizedpointfilters in the docs
...
breathe_projects = {
    "OrganizedPointFilters_CPP": "./_out/xml"
}

breathe_default_project = "OrganizedPointFilters_CPP"
...
htmlhelp_basename = 'OrganizedPointFiltersdoc'
...
man_pages = [(master_doc, 'organizedpointfilters', u'OrganizedPointFilters Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'OrganizedPointFilters', u'OrganizedPointFilters Documentation', author, 'OrganizedPointFilters',
