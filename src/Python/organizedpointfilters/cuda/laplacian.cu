...
__device__ void ReadBlockAndHalo(float* SHM_POINTS, const float* opc, const int& shmRow_y, const int& shmCol_x,
...
__global__ void SmoothPoint(float* SHM_POINTS, const float* opc, float* opc_out, const int& srcIdx, const int& shmRow_y,
                            const int& shmCol_x, const int& srcRow_y, const int& srcCol_x, const int& cols,
                            const float& lambda)
{
